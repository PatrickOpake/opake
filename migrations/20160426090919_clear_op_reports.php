...
class ClearOpReports extends BaseMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $this->query("
            ALTER TABLE `case_op_report_custom_field_value` DROP `field_id`;
            ALTER TABLE `case_op_report_future_custom_field_value` DROP `field_id`;
