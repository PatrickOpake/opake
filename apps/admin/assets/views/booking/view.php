	...
	<div>
		...
		<div ng-if="bookingVm.template">
			<div class="row">
				...
				<div class="col-sm-7">
					<h4 class="text-right">Search for existing new patientssss or create a new patient below</h4>
				</div>
			</div>
			...
			<div ng-if="bookingVm.booking" warning-unsaved-form="bookingVm.booking">
				...
				<div class="bottom-buttons top-buffer">
					...
					<div class="pull-right">
						...
						<a ng-if="!loggedUser.isSatelliteOffice() && !loggedUser.isBiller()" class="btn btn-primary" href=""  ng-click="bookingVm.schedule()">ScheduleNewMore</a>
