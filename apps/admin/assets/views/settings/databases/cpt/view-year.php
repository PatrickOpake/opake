<div ng-controller="SettingsCPTYearViewCtrl as listVm" ng-init="listVm.init(<?= $year_id ?>)" class="content-block" ng-cloak>
	<div class="row cpt-codes-header">
		<div class="col-sm-3">
			<a href="/settings/databases/cpt" class="back"><i class="glyphicon glyphicon-chevron-left"></i>Back</a>
		</div>
