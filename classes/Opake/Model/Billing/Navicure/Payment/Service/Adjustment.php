...
namespace Opake\Model\Billing\Navicure\Payment\Service;

use Opake\Model\AbstractModel;

class Adjustment extends AbstractModel
{
	const TYPE_CONTRACTUAL_OBLIGATIONS = 1;
	const TYPE_OTHER_ADJUSTMENTS = 2;
	const TYPE_PAYOR_INITIATED_REDUCTIONS = 3;
	const TYPE_PATIENT_RESPONSIBILITY = 4;

	public $id_field = 'id';
	public $table = 'billing_navicure_payment_service_adjustment';
	protected $_row = [
		'id' => null,
	...
	protected $formatters = [
		'ListEntry' => [
			'class' => '\Opake\Formatter\Billing\Navicure\Payment\Service\Adjustment\ListEntryFormatter'
		]
	];

	public static function getTypesDescriptionList()
	{
		return [
			\Opake\Model\Billing\Navicure\Payment\Service\Adjustment::TYPE_CONTRACTUAL_OBLIGATIONS => 'Contractual Obligations',
			\Opake\Model\Billing\Navicure\Payment\Service\Adjustment::TYPE_OTHER_ADJUSTMENTS => 'Other Adjustments',
			\Opake\Model\Billing\Navicure\Payment\Service\Adjustment::TYPE_PAYOR_INITIATED_REDUCTIONS => 'Payor Initiated Reductions',
			\Opake\Model\Billing\Navicure\Payment\Service\Adjustment::TYPE_PATIENT_RESPONSIBILITY => 'Patient Responsibility'
		];
	}

	public static function getReasonCodesDescriptionList()
	{
		return [
			1 => 'Deductible Amount',
			...
			5 => 'The procedure code/bill type is inconsistent with the place of service. Usage: Refer to the 835 Healthcare Policy Identification Segment (loop 2110 Service Payment Information REF), if present.',
			...
			16 => 'Claim/service lacks information or has submission/billing error(s) which is needed for adjudication. Do not use this code for claims attachment(s)/other documentation. At least one Remark Code must be provided (may be comprised of either the NCPDP Reject Reason Code, or Remittance Advice Remark Code that is not an ALERT.) Usage: Refer to the 835 Healthcare Policy Identification Segment (loop 2110 Service Payment Information REF), if present.',
