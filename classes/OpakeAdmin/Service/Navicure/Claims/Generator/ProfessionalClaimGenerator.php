...
class ProfessionalClaimGenerator extends ClaimGenerator
{
	public function getCaseErrors()
	{
		$checker = new \OpakeAdmin\Service\ASCX12\E837\Request\CaseClaimErrorChecker($this->case);
	...
	public function tryToSendClaim()
	{
		...
		$newClaim->type = Claim::TYPE_ELECTRONIC_1500_CLAIM;
		$newClaim->save();

		try {
			$claimGen = new \OpakeAdmin\Service\ASCX12\E837\Request\CaseClaimGenerator($this->case, $newClaim, $this->collectionOfBills);
		...
		$logRecord->transaction = Log::TRANSACTION_837;
	...
	{
		return $this->hasUnresolvedClaimForType(Claim::TYPE_ELECTRONIC_1500_CLAIM);
	}
}